...
class ProfilesPage(QtWidgets.QWidget):
    ...
    def set_data(self):
        for state in ["AL", "AK", "AS", "AZ", "AR", "CA", "CO", "CT", "DE", "DC", "FM", "FL", "GA", "GU", "HI", "ID", "IL", "IN", "IA", "KS", "KY", "LA", "ME", "MH", "MD", "MA", "MI", "MN", "MS", "MO", "MT", "NE", "NV", "NH", "NJ", "NM", "NY", "NC", "ND", "MP", "OH", "OK", "OR", "PW", "PA", "PR", "RI", "SC", "SD", "TN", "TX", "UT", "VT", "VI", "VA", "WA", "WV", "WI", "WY"]:
            self.shipping_state_box.addItem(state)
            self.billing_state_box.addItem(state)
        self.shipping_state_box.addItem("-----------")
        self.shipping_state_box.addItem("Canada Provinces")
        self.billing_state_box.addItem("-----------")
        self.billing_state_box.addItem("Canada Provinces")
        for province in ['AB', 'BC', 'MB', 'NB', 'NL', 'NT', 'NS', 'NU', 'ON', 'PE', 'QC', 'SK', 'YT']:
            self.shipping_state_box.addItem(province)
            self.billing_state_box.addItem(province)
